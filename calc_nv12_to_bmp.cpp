...
int main() {
    ...
    std::cout << "BGR to NV12 conversion time: " << duration << " µs" << std::endl;
    ...
    std::cout << "NV12 to BGR conversion time : " << duration << " µs" << std::endl;
    ...
    duration = duration_cast<microseconds>(end - start).count();
    std::cout << "BGR to BMP conversion time: " << duration << " µs" << std::endl;
